...
O(n). I chose this because it should check starting from the start AND the end of the sentence and meet in the middle.
...
There are infinite number of sentences possible in this language since there are infinite number of adjectives that can be used and repeated.
...
Type 3 because it can be parsed by a finite state machine.
